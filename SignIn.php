...
<body background="signupbackround.jpg" style="opacity:1;">
    ...
    <br>   
        ...
        <div class="login-html" style="color:rgb(0, 0, 0) ;">
...
if(isset($_POST["submitbutton"])){
    $query = "SELECT * FROM game_generator.users WHERE username='".$_POST['user']."'and password='".$_POST['password']."'";
    $result = mysqli_query($database_connection,$query);
    
    $row_count = mysqli_num_rows($result);
    if((int)$row_count == 0){
        echo '<p style="color:red;">User or password are incorrect!</p>';
    }
...
?>
                        ...
                        <div class="group">
                            <input name="submitbutton" type="submit" class="button" value="Sign In" style="width:100px; height:40px ;" />
                        </div>
                    </div><br>
                    </div>
                    </div>
